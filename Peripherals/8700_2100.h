...
unsigned char Write_Byte_2100_8700(unsigned char SlaveID,unsigned char reg,unsigned char data); 				 
unsigned char Read_Byte_2100_8700(unsigned char SlaveID,unsigned char reg);

void Init_8700_2100(void);
